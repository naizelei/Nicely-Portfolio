...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gray-50 dark:bg-gray-800 scroll-mt-24">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                <div className=" flex items-center justify-center mr-4">
                  <Image
                    ...
                    className="w-10 h-8 text-gray-700 dark:text-white/70"
                    alt="email"
                  />
                </div>
                <div>
                  <a 
                    ...
                    className="text-gray-900 dark:text-white hover:text-[#E6A0FF] dark:hover:text-[#E6A0FF]"
                  >
                    {profile.email}
                  </a>
                </div>
              ...
              {profile.phone && (
                <div className="flex items-center">
                  <div className=" flex items-center justify-center mr-4">
                    <svg className="w-12 h-12 text-gray-700 dark:text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-[#D661FF] hover:bg-[#D661FF] disabled:bg-blue-400 text-white py-3 px-6 rounded-lg font-semibold transition-colors duration-300 flex items-center justify-center"
              >
                {isSubmitting ? (
                  <>
